...
### 三、Zookeeper
&emsp; Zookeeper是一个开源的分布式的，为分布式应用提供协调服务的Apache项目。分布式安装ZK，对ZK有一定的了解就可以了，了解它的应用场景，以及内部原理，跟着做一些操作，基本上有一些了解即可。 视频还是建议看最新，周阳版本虽然一开始听得很爽，但后面觉得他讲得不好，他讲的版本不是针对大数据方向的。 
#### 视频：  
&emsp; [我看过的版本](https://www.bilibili.com/video/av53962808?from=search&seid=14867728339471861924)  
&emsp; [尚硅谷周洋版本](https://www.bilibili.com/video/av64765091?from=search&seid=14867728339471861924)  
